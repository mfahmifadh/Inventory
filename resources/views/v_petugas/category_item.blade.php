        ...
        <div class="card card-warning">
            <div class="card-header">
                ...
                <h3 class="card-title right" style="float:right;">
                    <a href="{{ url('admin-master/create_warehouse') }}" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-add-category">
                        <i class="fas fa-plus-circle"></i> <b>KATEGORI</b>
                    </a>
                </h3>
            </div>
            <!-- /.card-header -->
    ...
    <div class="modal fade" id="modal-add-category">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="{{ url('admin-user/add_category_item') }}" method="POST">
            @csrf
    ...
    <div class="modal fade" id="modal-edit-category{{ $row->id_item_category }}">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form action="{{ url('admin-user/edit_category_item/'. $row->id_item_category) }}" method="POST">
            @csrf
                <div class="modal-body">
                  <div class="row">
                    <div class="col-md-12">
