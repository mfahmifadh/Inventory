            ...
            <div class="tab-content" id="custom-content-below-tabContent">
              ...
              <div class="tab-pane fade show active" id="custom-content-below-entryitem" role="tabpanel" aria-labelledby="custom-content-below-entryitem-tab">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <h6>Tanggal Masuk <span style="margin-right:4vh;"></span>: <b>{{ \Carbon\Carbon::parse($palletorderid->order_dt)->isoFormat('DD MMMM Y') }}</b></h6>
                  </div>
                  <div class="col-md-9">
                  ...
                  <div class="col-md-3">
                    <h6>Tanggal Deadline <span style="margin-right:2vh;"></span>: <b>{{ \Carbon\Carbon::parse($palletorderid->order_deadline)->isoFormat('DD MMMM Y') }}</b></h6>
                  </div>
                </div>
                @endforeach
                <br>
              ...
              <div class="tab-pane fade" id="custom-content-below-exititem" role="tabpanel" aria-labelledby="custom-content-below-exititem-tab">
                ...
                <table id="example2a" class="table table-bordered table-striped">
                    ...
                    <tr>
                      <td>{{ $no++ }}</td>
                      <td>{{ \Carbon\Carbon::parse($entryitem->order_tm)->isoFormat('H:M') }} /
              ...
              <div class="tab-pane fade" id="custom-content-below-history" role="tabpanel" aria-labelledby="custom-content-below-history-tab">
                ...
                <table id="example2b" class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <td>{{ \Carbon\Carbon::parse($history->item_entry_date)->isoFormat('H:M') }} /
                      ...
                      <td>
                          ...
                          @endif
                          @if($history->item_exit_date != '')
                            {{ \Carbon\Carbon::parse($history->item_exit_date)->isoFormat('H:M') }} /
